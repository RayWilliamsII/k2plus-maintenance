...
# ── args ────────────────────────────────────────────────────────────────────
TARGET_MDNS="${1:?Usage: $0 <target-mDNS-name> <ssh-user>}"
SSH_USER="${2:?Usage: $0 <target-mDNS-name> <ssh-user>}"
